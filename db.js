      ...
      if (menus && menus.length) {
        ...
        subMenuStmt.finalize(() => {
          ...
          const cards = [
            ...
            { menu: 'Home', title: '在线音乐', url: 'https://music.163.com', logo_url: 'https://p3.music.126.net/tBTNafgjNnTL1KlZMt7lVA==/18885211718935735.jpg', desc: '在线音乐' },
            { menu: 'Home', title: '在线电影', url: 'https://libretv.org', logo_url: 'https://img.icons8.com/color/240/cinema---v1.png', desc: '在线电影'  },
            { menu: 'Home', title: '免费接码', url: 'https://www.smsonline.cloud/zh', logo_url: '', desc: '免费接收短信验证码' },
            { menu: 'Home', title: '订阅转换', url: 'https://sub.xeton.dev', logo_url: 'https://img.icons8.com/color/96/link--v1.png', desc: '订阅转换工具' },
            { menu: 'Home', title: 'webssh', url: 'https://sshwifty.herokuapp.com', logo_url: 'https://img.icons8.com/fluency/240/ssh.png', desc: 'webssh终端管理工具' },
